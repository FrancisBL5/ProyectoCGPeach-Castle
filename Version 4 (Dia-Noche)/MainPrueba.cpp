...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].diffuse"), 1.0f * PointlightTrue, 0.0f * PointlightTrue, 1.0f * PointlightTrue);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].specular"), 1.0f * PointlightTrue, 0.0f * PointlightTrue, 1.0f * PointlightTrue);
