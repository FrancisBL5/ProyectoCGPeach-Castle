...
// Bowser Camara
float BowserCameraX = 0.0f, BowserCameraZ = 0.0f;
// Audio Sound
ISoundEngine* SoundEngine = createIrrKlangDevice();
ISoundEngine* SoundEngineNigth = createIrrKlangDevice();
ISoundEngine* ROAAAR = createIrrKlangDevice();
...
irrklang::ISoundSource* Rugido = ROAAAR->addSoundSourceFromFile("Soundtrack/Roooooooooooooooooooooaaaaaaaaaaaar.wav");
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecto Castillo Peach", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// SpotLight1
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight[0].position"), SpotLightPositions[0].x, SpotLightPositions[0].y, SpotLightPositions[0].z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight[0].direction"), SpotLightDirections[0].x, SpotLightDirections[0].y, SpotLightDirections[0].z);
		...
		// SpotLight2
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight[1].position"), SpotLightPositions[1].x, SpotLightPositions[1].y, SpotLightPositions[1].z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight[1].direction"), SpotLightDirections[1].x, SpotLightDirections[1].y, SpotLightDirections[1].z);
		...
		// SpotLight3
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight[2].position"), SpotLightPositions[2].x, SpotLightPositions[2].y, SpotLightPositions[2].z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight[2].direction"), SpotLightDirections[2].x, SpotLightDirections[2].y, SpotLightDirections[2].z);
		...
		//model = glm::translate(model, glm::vec3(camera.GetPosition().x - 0.75f, camera.GetPosition().y + (auxilar1 / 2000) - 1.0f, camera.GetPosition().z - 0.5f));
		model = glm::translate(model, glm::vec3(camera.GetPosition().x + BowserCameraX, camera.GetPosition().y + (auxilar1 / 2000) - 1.0f, camera.GetPosition().z + BowserCameraZ));
